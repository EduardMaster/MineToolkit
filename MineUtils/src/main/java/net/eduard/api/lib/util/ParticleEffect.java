    ...
    public static final class Reflections {
        ...
        public enum PacketType {
            ...
            public Class<?> getPacket() throws Exception {
                return this.packet == null ? (this.packet = Reflections.getClass(this.name, PackageType.MINECRAFT_SERVER)) : this.packet;
            }
        }
        ...
        public enum SubPackageType {
            ...
            SubPackageType() {
                this.name = (PackageType.CRAFTBUKKIT + "." + name().toLowerCase());
            }
