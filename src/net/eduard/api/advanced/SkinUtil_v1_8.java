...
/**
 * Classe alterada da internet para funcionar o sistema na 1.8
 * @author Eduard
 *
 */
public final class SkinUtil_v1_8 {
...
//	    }
	    ...
	    public void addToTab(final Player player, final Collection<? extends Player> players) {
	        ...
	        final PacketPlayOutPlayerInfo addPlayerInfo = new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.ADD_PLAYER, ((CraftPlayer)player).getHandle());
	        
	        final PacketPlayOutPlayerInfo updatePlayerInfo = new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.UPDATE_DISPLAY_NAME, ((CraftPlayer)player).getHandle());
	    ...
	    public static void removeFromTab(final Player player, final Player[] players) {
	        ...
	        final PacketPlayOutPlayerInfo removePlayerInfo = new PacketPlayOutPlayerInfo(EnumPlayerInfoAction.REMOVE_PLAYER, ((CraftPlayer)player).getHandle());
	        for (final Player online : players) {
	            if (!online.canSee(player)) {
	                continue;
	            }
