...
public class KitManager extends EventsManager {
	...
	public ArrayList<KitAbility> getKits(){
		return kits;
	}
	public KitManager() {
	...
	public void openShop(Player player) {
		...
		Inventory menu = kitsGui.open(player);
	...
	public void openKitSelector(Player player)
	{
		...
		for (KitAbility kit : kits) {
			...
			if (player.hasPermission(kit.REQUIRE_PERMISSION)) {
				player.sendMessage("§cAbrindo menu com kit "+kit.getName());
				menu.setItem(posicao,kit.getIcon());
				posicao++;
			}
	...
	public void register(Plugin plugin) {
		...
		this.shopGui.register(plugin);
		this.kitsGui.register(plugin);
