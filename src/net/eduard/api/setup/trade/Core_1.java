...
public class Core_1 {
	...
	public static List<Core_1> getVendas(String url) {
		List<Core_1> vendas = new ArrayList<>();
		try {
...
//			e.printStackTrace();
	...
	public static void checkOnline(JavaPlugin plugin, String url) {
		...
		List<Core_1> keys = getVendas(url);
		if (keys == null) {
