package net.eduard.api.setup.trade;
...
public class Core_3 {
	...
	private static Core_3 read(String text) {
		Core_3 shield = new Core_3();
	...
	private static Core_3 read(File file) {
		try {
			String text = Files
	...
	public static List<Core_3> getShields(String url) {
		try {
			List<Core_3> shields = new ArrayList<>();
	...
	public static boolean checkOnline(JavaPlugin plugin, String url) {
		...
		List<Core_3> keys = getShields(url);
