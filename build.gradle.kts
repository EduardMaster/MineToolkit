...
dependencies {
    ...
    implementation(project(":MineNMS"))
    implementation(project(":MineNMS-1_8_9"))
    implementation(project(":MineNMS-1_7"))
    implementation(project(":MineNMS-1_12"))
    implementation(project(":MineUtils"))
    implementation(project(":SQLManager"))
