...
public class PluginVenda {
	...
	public static void disablePlugin(JavaPlugin plugin, String error) {
		console("§cOcorreu um erro e o plugin sera desabilitado!");
		console("§fCausa: §e"+error);
	...
	public static void checkOnline(JavaPlugin plugin, String url) {
		...
		console("§aPlugin criado por Eduard");
		console("§aSite www.bit.ly/eduardsite");
		console("§aCanal www.bit.ly/eduardsubscribe");
		console("§aSkype live:eduardkiller");
		console("§aDiscord www.bit.ly/eduardwebchat");
		...
		if (!desc.getAuthors().contains("Eduard") | !desc.getWebsite()
				.equals("https://www.youtube.com/user/EduTutoriaisHD")) {
			disablePlugin(plugin, "Modificar a Plugin.yml");
			return;
		}
